...
/* Contient ma regle pour ma feuille */
ruleset
...
simple_selector
  = qualifiers:(id / class /dollar/ attrib / pseudo)+ {
      return {
...
id
  = id:HASH { return { type: "IDSelector", "value": id }; }
class
  = "." class_:IDENT { return { type: "ClassSelector", "value": class_ }; }
dollar
  = "$" dollar_:accepted_funtion { return { type: "Dollar", "value": dollar_ }; }
...
unicode
  = "\\" digits:$(h h? h? h? h? h?) ("\r\n" / [ \t\r\n\f])? {
      return String.fromCharCode(parseFloat(digits, 16));
    }
