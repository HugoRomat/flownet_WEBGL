...
var UI = (function () {
    ...
    UI.prototype.mouse_event = function () {
        var self = this;
        console.log(self);
        var canvas = document.getElementById("visFrame");
        console.log(canvas);
...
(function (Sparkiz_1) {
    var Sparkiz = (function () {
        ...
        Sparkiz.prototype.draw_map = function (projection) {
            var self = this;
            var array = [];
            d3.json("data/worldID.json", function (error, world) {
        ...
        Sparkiz.prototype.updateNodes = function () {
            ...
            for (var i = 0; i < self.nodes.length; i++) {
                ...
                self.webGL_nodes[i].position.set(self.nodes[i].x, self.nodes[i].y, self.nodes[i].z);
