    ...
    var Sparkiz = (function () {
        ...
        Sparkiz.prototype.updateLinks = function () {
            ...
            for (var i = 0; i < this.links.length; i += 1) {
                ...
                var curveSplineMaterial = new THREE.LineBasicMaterial({ color: 0x2c3e50, linewidth: 1, opacity: 1, transparent: true });
                ...
                for (var j = 0, f = 1; j < position.length - 1; j += 2, f++) {
                    ...
                    var curveSplineMaterial = new THREE.LineBasicMaterial({ color: 0x2c3e50, linewidth: 1, opacity: this.links_opacity, transparent: true });
                    var p = new THREE.Path(quadratic_path);
