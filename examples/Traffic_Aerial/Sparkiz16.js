...
(function (Sparkiz) {
    ...
    var Shader = (function () {
        ...
        Shader.prototype.set_fragment = function () {
            ...
            this.vertex += "            uniform int temporal_delay[20]; ";
...
var Mapping = (function () {
    function Mapping(confluentGraph) {
        ...
        this.particle_color_scale = d3.scale.linear().domain([0, 0]).interpolate(d3.interpolateHcl).range([d3.rgb('#000000'), d3.rgb("#0051FF")]);
        this.node_color_scale = d3.scale.category10();
...
var UI = (function () {
    function UI(ConfluentGraph, scene, camera, renderer, raycaster) {
    ...
    var Sparkiz = (function () {
            ...
            loader.load('helvetiker_bold.typeface.json', function (font) {
                ...
                for (var i = 0; i < self.nodes.length; i++) {
                    if (self.nodes[i].label_name != null) {
                        ...
                        mesh.position.x = self.nodes[i].x + 10;
        ...
        Sparkiz.prototype.createLinks = function () {
            ...
            for (var i = 0; i < this.links.length; i++) {
                ...
                this.links[i].source.x = Math.random() * 10;
                this.links[i].target.y = Math.random() * 10;
                this.links[i].source.x = Math.random() * 10;
                this.links[i].target.y = Math.random() * 10;
                path[0] = { x: this.links[i].source.x, y: this.links[i].source.y };
                path[1] = { x: this.links[i].target.x, y: this.links[i].target.y };
        ...
        Sparkiz.prototype.get_links = function () {
            ...
            for (var j = 0; j < this.links.length; j++) {
                array.push({ "id": j,
                    ...
                    "frequency_pattern": this.links[j].frequency_pattern,
                    "speed": this.links[j].speed,
                    "temporal_distribution": this.links[j].temporal_distribution,
                    "rank": [] });
            }
            return array;
        };
