...
import {flownet} from './ParticleVis'
import {UI} from './UI'
...
export class Main{
    ...
    //constructor(div,graph,width,height,bg_color){
        ...
        this.sparkiz = new flownet(this.nodes, this.links, this.interface_);
    ...
    /******** PERMET DE LANCER LE RENDERER AVEC UN TEMPS ABSOLU ********/           
    with_absolute_time(){
        //var self = this;
