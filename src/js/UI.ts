...
export class UI{
    ...
    constructor(particleVis, scene,  camera, renderer, raycaster, div){
    ...
    update(){
        ...
        /*if (self.state_machine == "hover" && self.temporary_object != undefined){
            //console.log(self.old_object, self.temporary_object)
            if (self.temporary_object.userData.type == "country"){
                //console.log(self.temporary_object)
                self.temporary_object.material.color.set( 0xE6E6E6 );
                if (self.first_time == true)  self.old_object = self.temporary_object; self.first_time=false;

                if (self.temporary_object.name != self.old_object.name){
                    self.old_object.material.color.set( 0x000000 );
                    self.old_object = self.temporary_object;
                }
        ...
        if (self.state_machine == "hover" && self.old_object != undefined){
            //console.log(self.temporary_object)
            if (self.temporary_object == undefined){//|| self.temporary_object.userData.type != "country"){
                
                console.log("HEY")
                self.old_object.material.color.set( 0x000000 );
                self.old_object = self.temporary_object;
            }
            else if (self.temporary_object.userData.type != "country"){
                self.old_object.material.color.set( 0x000000 );
                self.old_object = self.temporary_object;
            }
        ...
        /*if (self.state_machine == "hover" && self.temporary_object != undefined){
            ...
            if (self.temporary_object.name == "tube"){
                console.log(self.temporary_object)
                self.temporary_object.material.opacity = 0;
            }
        }*/
       ...
       var canvas = document.getElementById(self.div.slice( 1 ));
        ...
        function mouseMove(event){
            ...
            if (self.state_machine == "hover"){
                ...
                if (self.temporary_object != undefined){
                    if (self.temporary_object.userData.type == "node" || self.temporary_object.userData.type == "label") self.hilightNeighborood(self.temporary_object.userData)
                } 
                else self.unhilightNeighborood();
                // console.log(self.hasHilight)
                // self.unhilightNeighborood();
                // console.log(self.temporary_object.userData)
            }
